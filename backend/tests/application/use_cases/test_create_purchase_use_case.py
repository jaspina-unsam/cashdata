...
class TestCreatePurchaseUseCaseIntegration:
    ...
    def test_creates_purchase_with_single_installment_successfully(
        self, use_case, session_factory
    ):
        """
    ...
    def test_creates_purchase_with_multiple_installments_successfully(
        self, use_case, session_factory
    ):
        """
